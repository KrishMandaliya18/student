...
const Header = ({ setIsOpen }) => {
  ...
  useEffect(() => {
    ...
    const role = sessionStorage.getItem('student_Role');

    if(name){
      setStudentName(name)
      setStudentRole(role ||  'Student'
      )
    }
...
const handleLogout = async () => {
  ...
  return (
    <header className="h-20 px-6 lg:px-10 flex items-center justify-between sticky top-0 bg-[#020617]/80 backdrop-blur-lg z-40 border-b border-white/5">
